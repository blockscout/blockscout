...
config :explorer, Explorer.Market.Fetcher.Coin,
  ...
  enabled: !disable_exchange_rates?,
  enable_consolidation: true,
  cache_period: ConfigHelper.parse_time_env_var("EXCHANGE_RATES_CACHE_PERIOD", "10m")

config :explorer, Explorer.Market.Fetcher.Token,
  enabled: ConfigHelper.parse_bool_env_var("EXCHANGE_RATES_TOKENS_ENABLED", "true"),
  interval: ConfigHelper.parse_time_env_var("EXCHANGE_RATES_TOKENS_INTERVAL", "25s"),
  refetch_interval: ConfigHelper.parse_time_env_var("EXCHANGE_RATES_TOKENS_REFETCH_INTERVAL", "1h"),
  max_batch_size: ConfigHelper.parse_integer_env_var("EXCHANGE_RATES_TOKENS_MAX_BATCH_SIZE", 100)
