...
config :indexer, Indexer.Fetcher.Stats.HotContracts.Supervisor,
  disabled?: ConfigHelper.parse_bool_env_var("INDEXER_DISABLE_HOT_CONTRACTS_FETCHER"),
  enabled: !ConfigHelper.parse_bool_env_var("INDEXER_DISABLE_HOT_CONTRACTS_FETCHER")
