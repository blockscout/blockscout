...
config :block_scout_web, :footer,
  ...
  github_link_enabled: ConfigHelper.parse_bool_env_var("FOOTER_GITHUB_LINK_ENABLED"),
  github_link: System.get_env("FOOTER_GITHUB_LINK", "https://github.com/blockscout/blockscout"),
  twitter_link: System.get_env("FOOTER_TWITTER_LINK", "https://www.twitter.com/blockscoutcom/"),
