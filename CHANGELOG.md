...
| `CACHE_OPTIMISM_DEPOSITS_COUNT_PERIOD`                         | Interval to update the Optimism deposits count. Introduced in [#14733](https://github.com/blockscout/blockscout/pull/14733).                                                                                                                                                                                                                                                           | Version: v12.0.0\+ <br />Default: `1h` <br />Applications: API, Indexer   |
