  ...
  def call(conn, _opts) do
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        ...
        default-src 'self';\
        script-src 'self' 'unsafe-inline' 'unsafe-eval' https://hcaptcha.com https://assets.hcaptcha.com;\
        style-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com;\
        img-src 'self' * data:;\
        media-src 'self' * data:;\
        font-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.gstatic.com data:;\
        frame-src 'self' 'unsafe-inline' 'unsafe-eval' https://hcaptcha.com https://assets.hcaptcha.com;\
      "
    })
  end
