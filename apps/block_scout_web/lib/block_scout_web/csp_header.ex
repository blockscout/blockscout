  ...
  def call(conn, _opts) do
    ...
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        connect-src 'self' #{json_rpc_url} #{config[:mixpanel_url]} #{config[:amplitude_url]} #{websocket_endpoints(conn)} #{walletconnect_urls} https://www.google-analytics.com/ *.poa.network #{czilladx_url} #{trustwallet_url} https://stats.g.doubleclick.net/ #{pendo_app_url} #{pendo_io_static_url} #{pendo_cdn_url} #{pendo_static_url} #{pendo_data_url};\
        default-src 'self';\
        script-src 'self' 'unsafe-inline' 'unsafe-eval' #{google_url} https://www.googletagmanager.com https://www.google-analytics.com/ https://www.gstatic.com *.hcaptcha.com https://assets.hcaptcha.com #{coinzillatag_url} #{pendo_app_url} #{pendo_io_static_url} #{pendo_cdn_url} #{pendo_static_url} #{pendo_data_url} https://servedbyadbutler.com/app.js http://servedbyadbutler.com/adserve/;\
        ...
        frame-src 'self' 'unsafe-inline' 'unsafe-eval' #{google_url} *.hcaptcha.com #{czilladx_url} #{pendo_app_url} http://servedbyadbutler.com/;\
