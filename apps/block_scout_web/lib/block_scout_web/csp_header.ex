  ...
  def call(conn, _opts) do
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        connect-src 'self' #{websocket_endpoints(conn)} https://sokol.poa.network/ https://core.poa.network/ https://dai.poa.network https://request-global.czilladx.com https://raw.githubusercontent.com/; \
        default-src 'self';\
