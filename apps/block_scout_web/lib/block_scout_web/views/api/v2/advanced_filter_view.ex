defmodule BlockScoutWeb.API.V2.AdvancedFilterView do
    ...
    af_lists =
      ...
      |> Stream.map(fn advanced_filter ->
        ...
        [
          ...
          decimal_to_string_normal(advanced_filter.value),
          if(advanced_filter.type != "coin_transfer",
            do: Address.checksum(advanced_filter.token_transfer.token.contract_address_hash),
            else: nil
          ),
          if(advanced_filter.type != "coin_transfer",
            do: decimal_to_string_normal(advanced_filter.token_transfer.token.decimals),
            else: nil
          ),
          ...
          decimal_to_string_normal(advanced_filter.fee),
          decimal_to_string_normal(exchange_rate.usd_value),
          decimal_to_string_normal(opening_price),
          decimal_to_string_normal(closing_price)
        ]
      end)
  ...
  defp decimal_to_string_normal(nil), do: nil
  defp decimal_to_string_normal(decimal), do: Decimal.to_string(decimal, :normal)
end
