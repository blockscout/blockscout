...
defmodule BlockScoutWeb.API.RPC.AddressView do
  ...
  defp prepare_common_token_transfer(token_transfer, max_block_number, decoded_input) do
    ...
    %{
      ...
      "tokenName" => if(token_transfer.token, do: token_transfer.token.name, else: ""),
      "tokenSymbol" => if(token_transfer.token, do: token_transfer.token.symbol, else: ""),
      "tokenDecimal" => if(token_transfer.token, do: to_string(token_transfer.token.decimals), else: ""),
