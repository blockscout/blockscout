defmodule BlockScoutWeb.LayoutView do
  ...
  def dark_logo do
    Keyword.get(application_config(), :dark_logo)
  end
  ...
  def dark_logo_footer do
    Keyword.get(application_config(), :dark_logo_footer) || Keyword.get(application_config(), :dark_logo)
  end
