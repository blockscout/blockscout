defmodule BlockScoutWeb.BlockExternalTransactionController do
  ...
  alias BlockScoutWeb.{Controller, ExternalTransactionView}
  ...
  def index(conn, %{"block_hash_or_number" => formatted_block_hash_or_number}) do
    case param_block_hash_or_number_to_block(formatted_block_hash_or_number,
      ...
      {:ok, block} ->
        ...
        block_external_transaction_count = Chain.block_to_external_transaction_count(block.hash)
        ...
        render(
          ...
          block_external_transaction_count: block_external_transaction_count,
