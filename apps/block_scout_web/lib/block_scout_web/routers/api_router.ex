  ...
  scope "/v2", as: :api_v2 do
    ...
    scope "/optimism" do
      if Application.compile_env(:explorer, :chain_type) == :optimism do
        ...
        get("/batches", V2.OptimismController, :txn_batches)
        get("/batches/count", V2.OptimismController, :txn_batches_count)
        get("/batches/:l2_block_range_start/:l2_block_range_end", V2.OptimismController, :txn_batches)
        get("/batches/da/celestia/:height/:commitment", V2.OptimismController, :txn_batch_by_celestia_blob)
