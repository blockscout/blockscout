      ...
      .then(() => {
        ...
        window.ethereum.request({
          ...
          .then(function (txHash) {
            const successMsg = `<a href="/poa/sokol/tx/${txHash}">Canceling transaction</a> successfully sent to the network. The current one will change the status once canceling transaction will be confirmed.`
            Swal.fire({
              title: 'Success',
              html: successMsg,
              icon: 'success'
