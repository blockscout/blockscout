defmodule Explorer.Repo.Migrations.RemoveDuplicatedIndexes do
  ...
  def change do
    drop_if_exists index(:address_current_token_balances, [:address_hash, :block_number, :token_contract_address_hash], name: "address_current_token_balances_block_number_index")
    drop_if_exists index(:internal_transactions, [:to_address_hash], name: "internal_transactions_to_address_hash_index")
    drop_if_exists index(:internal_transactions, [:transaction_hash], name: "internal_transactions_transaction_hash_index")
    ...
    drop_if_exists index(:transactions, [:created_contract_address_hash], name: "transactions_created_contract_address_hash_index")
