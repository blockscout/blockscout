defmodule Explorer.Repo.Migrations.AddHotContractsDaily do
  ...
  def change do
    create table(:hot_contracts_daily, primary_key: false) do
    ...
    create(index(:hot_contracts_daily, ["date DESC", "total_gas_used DESC"], name: :idx_hot_contracts_date_gas))

    create(
      index(:hot_contracts_daily, ["date DESC", "transactions_count DESC"],
