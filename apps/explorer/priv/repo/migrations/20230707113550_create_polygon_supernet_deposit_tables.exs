defmodule Explorer.Repo.Migrations.CreatePolygonSupernetDepositTables do
  ...
  def change do
    create table(:polygon_supernet_deposits, primary_key: false) do
    ...
    create table(:polygon_supernet_deposit_executes, primary_key: false) do
      add(:msg_id, :bigint, null: false, primary_key: true)
    ...
    create(unique_index(:polygon_supernet_deposit_executes, :l2_transaction_hash))
    create(index(:polygon_supernet_deposits, :l1_block_number))
    create(index(:polygon_supernet_deposit_executes, :l2_block_number))
  end
end
