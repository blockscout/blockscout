defmodule Explorer.Repo.Migrations.AddressCoinBalancesPartitioning do
  ...
  #   execute("CREATE UNIQUE INDEX unfetched_balances on address_coin_balances(address_hash, block_number) WHERE value_fetched_at IS NULL;")

  #   execute("CREATE UNIQUE INDEX address_coin_balances_address_hash_block_number_index on address_coin_balances(address_hash, block_number);")

  #   execute("ALTER TABLE address_coin_balances_old DROP CONSTRAINT address_coin_balances_address_hash_fkey;")
  #   execute("ALTER TABLE address_coin_balances ADD CONSTRAINT address_coin_balances_address_hash_fkey FOREIGN KEY (address_hash) REFERENCES addresses(hash)")

  #   execute("CREATE TABLE archive_address_coin_balances PARTITION OF address_coin_balances
  #   FOR VALUES FROM (0) TO (6000000)
  #   TABLESPACE archivespace;")

  #   execute("CREATE TABLE operational_address_coin_balances PARTITION OF address_coin_balances
  #   FOR VALUES FROM (6000000) TO (60000000)
