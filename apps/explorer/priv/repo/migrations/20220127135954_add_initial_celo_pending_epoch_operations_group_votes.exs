defmodule Explorer.Repo.Migrations.AddInitialCeloPendingEpochOperationsGroupVotes do
  ...
  def up do
    ...
    (SELECT b.hash, true as epoch, (CASE WHEN b.number < 172800 THEN false ELSE true END) as validator_group FROM epoch_blocks eb LEFT JOIN blocks b ON b.number = eb.block_number where b.hash is not null)
