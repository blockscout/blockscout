defmodule Explorer.Counters.AddressTokenUsdSum do
  ...
  @spec address_tokens_fiat_sum([{Address.CurrentTokenBalance, Explorer.Chain.BridgedToken, Explorer.Chain.Token}]) ::
          Decimal.t()
  defp address_tokens_fiat_sum(token_balances) do
    token_balances
    |> Enum.reduce(Decimal.new(0), fn {token_balance, _, token}, acc ->
