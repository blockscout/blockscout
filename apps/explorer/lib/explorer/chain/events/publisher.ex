defmodule Explorer.Chain.Events.Publisher do
  ...
  @allowed_events ~w(addresses address_coin_balances address_token_balances blocks block_rewards internal_transactions celo_contract_event tracked_contract_event last_block_number token_transfers transactions contract_verification_result)a
