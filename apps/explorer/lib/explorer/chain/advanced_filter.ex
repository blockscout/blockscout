defmodule Explorer.Chain.AdvancedFilter do
  ...
  defp filter_by_tx_type(query_function, [_ | _] = tx_types) do
    fn query, unnested? ->
      query |> where([token_transfer], token_transfer.token_type in ^tx_types) |> query_function.(unnested?)
    end
  end

  defp filter_by_tx_type(query_function, _), do: query_function
