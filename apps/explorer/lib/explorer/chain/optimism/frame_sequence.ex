defmodule Explorer.Chain.Optimism.FrameSequence do
  ...
  @doc """
    ...
    - `batch_data_container`: Designates where the batch info is stored:
                              :in_blob4844, :in_celestia, :in_eigenda, :in_alt_da, or :in_calldata.
  ...
  @spec prepare_base_info_for_batch(
          ...
          non_neg_integer(),
          non_neg_integer(),
          :in_blob4844 | :in_celestia | :in_eigenda | :in_alt_da | :in_calldata | nil,
          __MODULE__.t()
