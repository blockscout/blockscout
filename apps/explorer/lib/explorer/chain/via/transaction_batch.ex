defmodule Explorer.Chain.Via.TransactionBatch do
  @moduledoc "Models a batch of transactions for Via."
  ...
  alias Explorer.Chain.Via.{BatchTransaction, LifecycleTransaction}
  ...
  schema "via_transaction_batches" do
