defmodule Explorer.Chain.InternalTransaction do
  ...
  @call_required_fields ~w(call_type from_address_hash gas index input to_address_hash transaction_hash)a
  ...
  @create_required_fields ~w(from_address_hash gas index init transaction_hash)a
  ...
  @selfdestruct_required_fields ~w(from_address_hash index to_address_hash transaction_hash type)a
  ...
  @stop_required_fields ~w(block_number transaction_hash transaction_index index type)a
