defmodule Explorer.Chain.Import.Runner.Zilliqa.Zrc2.TokenTransfers do
  ...
  alias Explorer.Chain.Zilliqa.Zrc2.TokenTransfer
    ...
    from(
      ...
      update: [
        set: [
          ...
          zrc2_address_hash: fragment("EXCLUDED.zrc2_address_hash"),
      ...
      where:
        fragment(
          "(EXCLUDED.from_address_hash, EXCLUDED.to_address_hash, EXCLUDED.amount, EXCLUDED.zrc2_address_hash, EXCLUDED.block_number) IS DISTINCT FROM (?, ?, ?, ?, ?)",
          token_transfer.from_address_hash,
          token_transfer.to_address_hash,
          token_transfer.amount,
          token_transfer.zrc2_address_hash,
