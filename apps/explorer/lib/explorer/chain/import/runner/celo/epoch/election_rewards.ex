defmodule Explorer.Chain.Import.Runner.Celo.Epoch.ElectionRewards do
  @moduledoc """
  ...
  @impl Import.Runner
  def option_key, do: :celo_epoch_election_rewards
  ...
  def run(multi, changes_list, %{timestamps: timestamps} = options) do
    ...
    Multi.run(multi, :insert_celo_epoch_election_rewards, fn repo, _ ->
