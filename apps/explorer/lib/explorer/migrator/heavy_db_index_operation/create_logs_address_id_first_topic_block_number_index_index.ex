...
defmodule Explorer.Migrator.HeavyDbIndexOperation.CreateLogsAddressIdFirstTopicBlockNumberIndexIndex do
  @moduledoc """
  Create B-tree index `logs_address_id_first_topic_block_number_index_index` on `logs` table for (`address_id`, `first_topic`, `block_number`, `index`) columns.
  """
  ...
  @table_name :logs
  @index_name "logs_address_id_first_topic_block_number_index_index"
  @operation_type :create
  @table_columns ["address_id", "first_topic", "block_number", "index"]
  ...
  @impl HeavyDbIndexOperation
  def update_cache do
    BackgroundMigrations.set_heavy_indexes_create_logs_address_id_first_topic_block_number_index_index_finished(true)
  end
end
