defmodule Explorer.Migrator.HeavyDbIndexOperation.CreateTokensOrdMcapFiatHolderNameIndex do
  @moduledoc """
  Create B-tree index `idx_tokens_ord_mcap_fiat_holder_name` on `tokens` table
  for (`circulating_market_cap DESC NULLS LAST`, `fiat_value DESC NULLS LAST`,
  `holder_count DESC NULLS LAST`, `name`).
  """
  ...
  @table_name :tokens
  @index_name "idx_tokens_ord_mcap_fiat_holder_name"
  ...
  @impl HeavyDbIndexOperation
  def update_cache do
    BackgroundMigrations.set_heavy_indexes_create_idx_tokens_ord_mcap_fiat_holder_name_finished(true)
  end
end
