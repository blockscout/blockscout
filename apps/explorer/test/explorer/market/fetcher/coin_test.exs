defmodule Explorer.Market.Fetcher.CoinTest do
  ...
  setup do
    ...
    fetcher_configuration = Application.get_env(:explorer, Explorer.Market.Fetcher.Coin)
    ...
    Application.put_env(:explorer, Explorer.Market.Fetcher.Coin, table_name: :rates)
    Application.put_env(:explorer, Explorer.Market.Fetcher.Coin, enabled: true)

    on_exit(fn ->
      Application.put_env(:explorer, Explorer.Market.Source, source_configuration)
      Application.put_env(:explorer, Explorer.Market.Fetcher.Coin, fetcher_configuration)
