    ...
    test "decodes base64 encoded json file in tokenURI" do
      data = %{
        "c87b56dd" =>
          {:ok,
           [
             "data:application/json;base64,"
           ]}
      }
