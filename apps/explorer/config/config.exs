...
config :explorer, Explorer.ChainSpec.GenesisData,
  enabled: true,
  celo_network: System.get_env("SUBNETWORK", "Baklava").downcase,
  chain_spec_path: System.get_env("CHAIN_SPEC_PATH", "https://www.googleapis.com/storage/v1/b/genesis_blocks/o/#{celo_network}?alt=media"),
