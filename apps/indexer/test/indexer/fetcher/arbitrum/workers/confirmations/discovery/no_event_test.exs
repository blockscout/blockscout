...
if Application.get_env(:explorer, :chain_type) == :arbitrum do
  defmodule Indexer.Fetcher.Arbitrum.Workers.Confirmations.Discovery.NoEventTest do
    ...
    # rare. The parent chain holds many blocks.
    describe "perform/5 with no event" do
      # The database has one batch with the rollup blocks 1..10. No block in the batch
      # is confirmed.
      #
      # The discovery range holds no event. So the discovery examines no rollup
      ...
      # that gives such lists to the import.
