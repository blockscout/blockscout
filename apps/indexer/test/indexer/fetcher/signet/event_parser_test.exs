defmodule Indexer.Fetcher.Signet.EventParserTest do
  ...
  describe "parsed event structure" do
    test "parsed orders contain expected fields" do
      ...
      assert :inputs_json in expected_fields
      assert :outputs_json in expected_fields
    end

    test "parsed fills contain expected fields" do
