defmodule Indexer.BufferedTask do
  ...
  * `task_ref_to_batch` - map of task references to their corresponding batches.
  ...
  # Handles the successful completion of a task processing queue data, removes it
  # from the state, and triggers processing of the next batch if queue contains data.
