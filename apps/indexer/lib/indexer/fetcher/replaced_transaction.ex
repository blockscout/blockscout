defmodule Indexer.Fetcher.ReplacedTransaction do
  ...
  @max_batch_size Indexer.Fetcher.parse_env("MAX_BATCH_SIZE_REPLACED_TRANSACTION") || 10
  @max_concurrency Indexer.Fetcher.parse_env("MAX_CONCURRENCY_REPLACED_TRANSACTION") || 2
  @defaults [
