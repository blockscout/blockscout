      ...
      expected_batch_number ->
        ...
        case next_action do
          ...
          :look_for_batches ->
            ...
            prove_tx = Rpc.fetch_tx_by_hash(transaction_hash, json_l1_rpc_named_arguments)
            batches_numbers_from_rpc = get_proven_batches_from_calldata(prove_tx["input"])

            associate_and_import_or_prepare_for_recovery(batches_numbers_from_rpc, l1_txs, transaction_hash, :prove_id)
        end
    end
  end
