defmodule Indexer.Fetcher.PolygonZkevm.TransactionBatch do
    ...
    {batches_to_import, l2_txs_to_import, l1_txs_to_import, _, _} =
      ...
      |> Enum.reduce({[], [], [], Reader.next_id(), hash_to_id}, fn res,
        ...
        {sequence_id, l1_txs, next_id, hash_to_id} =
          ...
          |> handle_transaction_hash(hash_to_id, next_id, l1_txs, false)
        ...
        {verify_id, l1_txs, next_id, hash_to_id} =
          ...
          |> handle_transaction_hash(hash_to_id, next_id, l1_txs, true)
        ...
        {[batch | batches], l2_txs ++ l2_transactions_append, l1_txs, next_id, hash_to_id}
      end)
  ...
  defp handle_transaction_hash(encoded_transaction_hash, hash_to_id, next_id, l1_txs, is_verify) do
    if encoded_transaction_hash != @zero_hash do
      ...
      if is_nil(id) do
        {next_id, [%{id: next_id, hash: transaction_hash, is_verify: is_verify} | l1_txs], next_id + 1,
