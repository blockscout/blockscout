defmodule Indexer.Fetcher.Via.Utils.Rpc do
  @moduledoc """
    Common functions to handle RPC calls for Indexer.Fetcher.Via fetchers
  """
  ...
  @doc """
    ...
    into a map that can be used by Indexer.Fetcher.Via fetchers for further handling.
  ...
  @doc """
    ...
    can be used by Indexer.Fetcher.Via fetchers for further handling.
