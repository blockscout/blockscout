defmodule Indexer.Fetcher.Via.Discovery.Workers do
  @moduledoc """
    Provides functions to download a set of batches from RPC and import them to DB.
  """

  alias Indexer.Fetcher.Via.Utils.Db
  alias Indexer.Prometheus.Instrumenter

  import Indexer.Fetcher.Via.Discovery.BatchesData,
    only: [
  ...
  @doc """
    ...
    Later `Indexer.Fetcher.Via.BatchesStatusTracker` will update any batch state changes and
