defmodule Indexer.Fetcher.Via.Discovery.BatchesData do
  @moduledoc """
  ...
  import Indexer.Fetcher.Via.Utils.Logging, only: [log_info: 1, log_details_chunk_handling: 4]
  ...
  #           must be pruned (see Indexer.Fetcher.Via.Utils.Db.prune_json_batch/1).
  #
  # ## Parameters
  ...
  #
  # This function is not part of the `Indexer.Fetcher.Via.Utils.Rpc` module since the resulting
