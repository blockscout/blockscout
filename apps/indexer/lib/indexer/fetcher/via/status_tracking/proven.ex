defmodule Indexer.Fetcher.Via.StatusTracking.Proven do
  @moduledoc """
  ...
  import Indexer.Fetcher.Via.Utils.Logging, only: [log_error: 1, log_info: 1]
      ...
      expected_batch_number ->
        ...
        case next_action do
          ...
          :look_for_batches ->
            ...
            # # Todo: fetch the data from the inscription???
  ...
  defp get_proven_batches_from_calldata(calldata) do
    ...
    # /// @param commitment Verified input for the via circuit
