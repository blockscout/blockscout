  ...
  def init(%{memory_monitor: memory_monitor}) do
    ...
    basic_fetchers =
      [
        ...
        {Indexer.Fetcher.PolygonSupernet.Deposit.Supervisor, [[memory_monitor: memory_monitor]]},
        {Indexer.Fetcher.PolygonSupernet.DepositExecute.Supervisor,
         [[memory_monitor: memory_monitor, json_rpc_named_arguments: json_rpc_named_arguments]]},
        {Indexer.Fetcher.PolygonSupernet.Withdrawal.Supervisor,
         [[memory_monitor: memory_monitor, json_rpc_named_arguments: json_rpc_named_arguments]]},
        {Indexer.Fetcher.PolygonSupernet.WithdrawalExit.Supervisor, [[memory_monitor: memory_monitor]]},
