  ...
  def init(%{memory_monitor: memory_monitor}) do
    ...
    basic_fetchers =
      [
        ...
        {Indexer.Fetcher.Optimism.OutputRoot.Supervisor, [[memory_monitor: memory_monitor]]},
        {Indexer.Fetcher.Optimism.Deposit.Supervisor, [[memory_monitor: memory_monitor]]},
        {Indexer.Fetcher.Optimism.Withdrawal.Supervisor,
         [[memory_monitor: memory_monitor, json_rpc_named_arguments: json_rpc_named_arguments]]},
        {Indexer.Fetcher.Optimism.WithdrawalEvent.Supervisor, [[memory_monitor: memory_monitor]]},
