defmodule Indexer.Supervisor do
  ...
  alias Indexer.Fetcher.MultichainSearchDbExport.BalancesQueueProcessor, as: MultichainSearchDbBalancesQueueProcessor
  alias Indexer.Fetcher.MultichainSearchDbExport.MainQueueProcessor, as: MultichainSearchDbMainExportMainQueueProcessor
  ...
  def init(%{memory_monitor: memory_monitor}) do
    ...
    basic_fetchers =
      [
        ...
        {MultichainSearchDbBalancesQueueProcessor.Supervisor, [[memory_monitor: memory_monitor]]},
        {MultichainSearchDbMainExportMainQueueProcessor.Supervisor, [[memory_monitor: memory_monitor]]},
