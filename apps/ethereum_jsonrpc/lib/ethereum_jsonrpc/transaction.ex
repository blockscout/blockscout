defmodule EthereumJSONRPC.Transaction do
  ...
  @type params :: %{
          ...
          gas_currency: EthereumJSONRPC.address(),
          gas_fee_recipient: EthereumJSONRPC.address(),
  ...
  def elixir_to_params(
        %{
          ...
          "gas" => gas,
          "gasPrice" => gas_price,
          "gasCurrency" => gas_currency,
          "gasFeeRecipient" => gas_fee_recipient,
          "hash" => hash,
          "input" => input,
          "nonce" => nonce,
          "r" => r,
    ...
    result = %{
      ...
      gas_fee_recipient: gas_fee_recipient,
      hash: hash,
      index: index,
      input: input,
      nonce: nonce,
